            ...
            <?php foreach ($lots as $lot): ?>
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?=strip_tags($lot['image_link']); ?>" width="350" height="260" alt="<?=strip_tags($lot['name']); ?>">
                    </div>
                    <div class="lot__info">
                        ...
                        <div class="lot__state">
                            <div class="lot__rate">
                                ...
                                <span class="lot__cost"><?=format_price(strip_tags($lot['starting_price'])); ?></span>
                            </div>
                            <?php
                                $time_before = get_time_before($lot['end_time']);
                            ?>
